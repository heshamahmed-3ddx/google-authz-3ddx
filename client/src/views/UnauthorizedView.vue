      ...
      <v-col cols="12" sm="10" md="8" lg="6">
        <v-card elevation="3" class="text-center pa-8">
          ...
          <v-alert type="warning" variant="tonal" class="mb-6 text-left">
            ...
            <p class="mb-2">
              {{
                $t("errors.403.permissionInfo") ||
                "This page requires specific permissions or group membership."
              }}
            </p>
            <p v-if="authStore.user" class="mb-2">
          ...
          >
            ...
            <p class="mb-2">
              ...
              <code>{{ requiredGroups || "Unknown" }}</code>
            </p>
            <p class="mb-0">
              <strong>Tip:</strong> Enable "Admin View" in Dev Toolbar to bypass
              permissions.
            </p>
          </v-alert>
...
const userGroups = computed(() => {
  ...
  if (import.meta.env.DEV) {
    console.log(
      "[UnauthorizedView] Groups from cachedUserRights:",
      authStore.cachedUserRights?.groups,
    );
    console.log(
      "[UnauthorizedView] Groups from user object:",
