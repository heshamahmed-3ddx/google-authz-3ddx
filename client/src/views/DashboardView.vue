                  ...
                  <div>
                    ...
                    <div class="d-flex align-center mt-2">
                      <span class="text-body-2 mr-2"
                        >ID: {{ authStore.user.id }}</span
                      >
                      <v-btn
                        icon
                        size="small"
                        :title="$t('dashboard.copyUserId')"
                        @click="copyUserId"
                      >
              ...
              <v-col cols="12" md="6">
                <v-list density="compact">
                  ...
                  <v-list-item>
                    ...
                    <v-list-item-subtitle>{{
                      authStore.user.locale || $t("dashboard.notProvided")
                    }}</v-list-item-subtitle>
                  </v-list-item>
                  <v-list-item>
                    <v-list-item-title>{{
              ...
              <v-col cols="12" md="6">
                <v-list density="compact">
                  ...
                  <v-list-item>
                    ...
                    <v-list-item-subtitle>{{
                      userDetails.orgUnit || $t("dashboard.unknown")
                    }}</v-list-item-subtitle>
                  </v-list-item>
                  <v-list-item>
                    <v-list-item-title>{{
                    ...
                    <v-list-item-subtitle>{{
                      userDetails.department || $t("dashboard.unknown")
                    }}</v-list-item-subtitle>
                  </v-list-item>
                </v-list>
              </v-col>
                ...
                <v-list density="compact">
                  <v-list-item>
                    ...
                    <v-list-item-subtitle>
                      <v-chip
                        :color="
                          userDetails.twoStepEnabled ? 'success' : 'warning'
                        "
                        size="small"
                      >
                        {{
        ...
        <v-card class="mb-6" elevation="3">
          ...
          <v-card-text>
            <v-list density="compact">
              <v-list-item>
                <v-list-item-title>{{
                  $t("dashboard.authenticationStatus")
                }}</v-list-item-title>
                <v-list-item-subtitle>
                  <v-chip color="success" size="small">{{
...
const isAdmin = computed(() => {
  ...
  return (
    userRights.value.groups.includes("admin") ||
...
async function refreshProfile() {
  ...
  try {
    ...
    showToast(
      t("dashboard.profileRefreshed") || "Profile refreshed successfully!",
    );
  } catch (error) {
...
onMounted(async () => {
  ...
  await Promise.all([fetchUserDetails(), fetchUserRights()]);
});
</script>
