if (!self.define) {
  ...
  self.define = (n, i) => {
    ...
    let o = {};
    const a = (e) => s(e, c),
      r = { module: { uri: c }, exports: o, require: a };
    t[c] = Promise.all(n.map((e) => r[e] || a(e))).then((e) => (i(...e), o));
  };
}
define(["./workbox-8370131a"], function (e) {
  "use strict";
  (self.skipWaiting(),
    e.clientsClaim(),
    e.precacheAndRoute(
      [
        ...
        { url: "index.html", revision: "0.ifcck4fc03" },
      ],
      {},
    ),
    ...
    e.registerRoute(
      /\/auth\/.*/i,
      new e.NetworkOnly({ cacheName: "auth-cache", plugins: [] }),
      "GET",
    ));
});
